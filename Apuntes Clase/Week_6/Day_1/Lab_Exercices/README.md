...
Open the `Lab Supervised Learnin.ipynb` file in the directory. Follow the instructions and add your code and explanations as necessary.

## Deliverables

- `Lab Supervised Learning.ipynb` with your responses.

## Submission

Upon completion, add your deliverables to git or your google drive. Then send your solutions thought student portal, remember give permissions on google drive.
